...
const char monthStr1[] PROGMEM = "januari";
const char monthStr2[] PROGMEM = "februari";
const char monthStr3[] PROGMEM = "maart";
const char monthStr4[] PROGMEM = "april";
const char monthStr5[] PROGMEM = "mei";
const char monthStr6[] PROGMEM = "juni";
const char monthStr7[] PROGMEM = "juli";
const char monthStr8[] PROGMEM = "augustus";
...
const char dayStr1[] PROGMEM = "Zondag";
const char dayStr2[] PROGMEM = "Maandag";
const char dayStr3[] PROGMEM = "Dinsdag";
const char dayStr4[] PROGMEM = "Woensdag";
const char dayStr5[] PROGMEM = "Donderdag";
const char dayStr6[] PROGMEM = "Vrijdag";
const char dayStr7[] PROGMEM = "Zaterdag";
